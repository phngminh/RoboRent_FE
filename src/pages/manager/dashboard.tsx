        ...
        <div className='overflow-x-auto'>
          <table className='w-full'>
            <thead className='bg-gray-50'>
              <tr>
                <th className='px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider'>Rental ID</th>
            ...
            <tbody className='bg-white divide-y divide-gray-200'>
              {[
                ...
                <tr key={rental.id} className='hover:bg-gray-50'>
                  <td className='px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-center'>{rental.id}</td>
                  <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-center'>{rental.item}</td>
                  <td className='px-6 py-4 whitespace-nowrap text-center'>
                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${rental.statusColor}`}>
                      {rental.status}
                    </span>
                  </td>
                  <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-center'>{rental.amount}</td>
                  <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-center'>{rental.date}</td>
